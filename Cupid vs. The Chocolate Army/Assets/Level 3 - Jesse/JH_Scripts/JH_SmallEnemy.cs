...
public class JH_SmallEnemy : MonoBehaviour
{
    [Header("Enemy Stats")]
    [SerializeField] float health = 100;
    [SerializeField] int scoreValue = 70;
    ...
    Animator HardCandyHit;

    // Start is called before the first frame update
    void Start()
    {
        HardCandyHit = GetComponent<Animator>();
    }
    ...
    void Update()
    {
        ...
        if (health <= 0)
        {
            HardCandyHit.SetBool("isDying", true);
            Die();
        }
    }
